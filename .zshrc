...
zinit ice wait lucid depth'1' atinit'export ZENO_ENABLE_SOCK=1; export ZENO_ENABLE_FZF_TMUX=1' blockf; zinit light 'yuki-yano/zeno.zsh'
...
zinit ice wait silent as'program' from'gh-r' bpick"*-$(uname -m)-*-$(ostype)*" pick'tokei/tokei'; zinit light 'XAMPPRocky/tokei'
