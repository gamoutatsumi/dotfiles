...
return { ["$schema"] = "https://json.schemastore.org/schema-catalog.json", version = 1, schemas = {
  { name = ".adonisrc.json", description = "AdonisJS configuration file", fileMatch = { ".adonisrc.json" },
    url = "https://raw.githubusercontent.com/adonisjs/application/master/adonisrc.schema.json" },
  {
    ...
    versions = { ["1.2"] = "https://json.schemastore.org/agripparc-1.2.json",
      ["1.3"] = "https://json.schemastore.org/agripparc-1.3.json" }
  },
  { name = ".aiproj.json", description = "Settings for project analysis by the application inspector",
    fileMatch = { ".aiproj.json" }, url = "https://json.schemastore.org/aiproj.json" },
  {
    name = "Airlock Microgateway",
    description = "Airlock Microgateway configuration schema",
    url = "https://json.schemastore.org/airlock-microgateway-3.1.json",
    fileMatch = { "microgateway-config.yaml", "microgateway-config.yml", "airlock-microgateway-config.yaml",
      "airlock-microgateway-config.yml" },
    versions = { ["3.0"] = "https://json.schemastore.org/airlock-microgateway-3.0.json",
      ["3.1"] = "https://json.schemastore.org/airlock-microgateway-3.1.json" }
  },
  { name = "angular.json", description = "Angular configuration file", fileMatch = { "angular.json" },
    url = "https://raw.githubusercontent.com/angular/angular-cli/master/packages/angular/cli/lib/config/workspace-schema.json" },
  { name = ".angular-cli.json", description = "Angular CLI configuration file",
  ...
  { name = "Ansible Playbook", description = "Ansible playbook files",
    url = "https://json.schemastore.org/ansible-playbook.json", fileMatch = { "playbook.yml", "playbook.yaml" } },
  { name = "Ansible Inventory", description = "Ansible inventory files",
    url = "https://json.schemastore.org/ansible-inventory.json", fileMatch = { "inventory.yml", "inventory.yaml" } },
  { name = "Ansible Collection Galaxy", description = "Ansible Collection Galaxy metadata",
    url = "https://raw.githubusercontent.com/ansible-community/schemas/main/f/ansible-galaxy.json",
    fileMatch = { "galaxy.yml" } },
  { name = "apple-app-site-association", description = "Apple Universal Link, App Site Association",
    fileMatch = { "apple-app-site-association" }, url = "https://json.schemastore.org/apple-app-site-association.json" },
  { name = "app-definition.yaml", description = "Appsemble app definition", fileMatch = { "app-definition.yaml" },
    url = "https://appsemble.app/api.json#/components/schemas/AppDefinition" },
  { name = ".appsemblerc.yaml", description = "Appsemble RC file", fileMatch = { ".appsemblerc.yaml" },
    url = "https://gitlab.com/appsemble/appsemble/-/raw/HEAD/packages/cli/assets/appsemblerc.schema.json" },
  { name = "appsscript.json", description = "Google Apps Script manifest file", fileMatch = { "appsscript.json" },
    url = "https://json.schemastore.org/appsscript.json" },
  { name = "appsettings.json", description = "ASP.NET Core's configuration file",
    fileMatch = { "appsettings.json", "appsettings.*.json" }, url = "https://json.schemastore.org/appsettings.json" },
  { name = "appveyor.yml", description = "AppVeyor CI configuration file", fileMatch = { "appveyor.yml" },
    url = "https://json.schemastore.org/appveyor.json" },
  { name = "architect.yml", description = "Architect.io Component Schema",
  ...
  { name = "arc.json", description = "A JSON schema for OpenJS Architect",
    fileMatch = { "arc.json", "arc.yml", "arc.yaml" },
    url = "https://raw.githubusercontent.com/architect/parser/v2.3.0/arc-schema.json" },
  { name = "Argo Workflows", description = "Argo Workflow configuration file",
    url = "https://raw.githubusercontent.com/argoproj/argo-workflows/master/api/jsonschema/schema.json" },
  { name = "artifacthub-repo.yml", description = "Artifact Hub repository metadata file",
    fileMatch = { "artifacthub-repo.yml" }, url = "https://json.schemastore.org/artifacthub-repo.json" },
  { name = "Avro Avsc", description = "Avro Schema Avsc file", fileMatch = { "*.avsc" },
    url = "https://json.schemastore.org/avro-avsc.json" },
  { name = "Azure IoT EdgeAgent deployment", description = "Azure IoT EdgeAgent deployment schema",
    url = "https://json.schemastore.org/azure-iot-edgeagent-deployment-1.1.json",
    versions = { ["1.0"] = "https://json.schemastore.org/azure-iot-edgeagent-deployment-1.0.json",
      ["1.1"] = "https://json.schemastore.org/azure-iot-edgeagent-deployment-1.1.json" } },
  { name = "Azure IoT EdgeHub deployment", description = "Azure IoT EdgeHub deployment schema",
    url = "https://json.schemastore.org/azure-iot-edgehub-deployment-1.2.json",
    versions = { ["1.0"] = "https://json.schemastore.org/azure-iot-edgehub-deployment-1.0.json",
  ...
  { name = "Azure IoT Edge deployment", description = "Azure IoT Edge deployment schema",
    url = "https://json.schemastore.org/azure-iot-edge-deployment-2.0.json",
    versions = { ["1.0"] = "https://json.schemastore.org/azure-iot-edge-deployment-1.0.json",
      ["1.1"] = "https://json.schemastore.org/azure-iot-edge-deployment-2.0.json" } },
  {
    ...
    versions = { ["1.0"] = "https://json.schemastore.org/azure-iot-edge-deployment-template-1.0.json",
  ...
  { name = "Azure Pipelines", description = "Azure Pipelines YAML pipelines definition",
  ...
  { name = "Foxx Manifest", description = "ArangoDB Foxx service manifest file", fileMatch = { "manifest.json" },
    url = "https://json.schemastore.org/foxx-manifest.json" },
  { name = ".asmdef", description = "Unity 3D assembly definition file", fileMatch = { "*.asmdef" },
    url = "https://json.schemastore.org/asmdef.json" },
  { name = "babelrc.json", description = "Babel configuration file", fileMatch = { ".babelrc", "babel.config.json" },
    url = "https://json.schemastore.org/babelrc.json" },
  { name = ".backportrc.json", description = "Backport configuration file", fileMatch = { ".backportrc.json" },
    url = "https://json.schemastore.org/backportrc.json" },
  { name = "batect.yml", description = "Batect configuration file", fileMatch = { "batect.yml", "batect-bundle.yml" },
  ...
  { name = "bamboo-spec",
    ...
    url = "https://json.schemastore.org/bamboo-spec.json", fileMatch = { "bamboo-specs/*.yaml", "bamboo-specs/*.yml" } },
  ...
  { name = "bigquery-table", description = "BigQuery table schema",
    url = "https://json.schemastore.org/bigquery-table.json", fileMatch = { "*.bigquery.json" } },
  { name = "bitbucket-pipelines", description = "Bitbucket Pipelines CI/CD manifest schema",
  ...
  { name = "bitrise",
    ...
    url = "https://json.schemastore.org/bitrise.json", fileMatch = { "bitrise.yml", "bitrise.yaml", "bitrise.json" } },
  { name = "bitrise-step",
    ...
    url = "https://json.schemastore.org/bitrise-step.json", fileMatch = { "step.yml" } },
  { name = ".bootstraprc", description = "Webpack bootstrap-loader configuration file", fileMatch = { ".bootstraprc" },
    url = "https://json.schemastore.org/bootstraprc.json" },
  { name = "bower.json", description = "Bower package description file", fileMatch = { "bower.json", ".bower.json" },
    url = "https://json.schemastore.org/bower.json" },
  { name = ".bowerrc", description = "Bower configuration file", fileMatch = { ".bowerrc" },
    url = "https://json.schemastore.org/bowerrc.json" },
  { name = "behat.yml", description = "Behat configuration file", fileMatch = { "behat.yml", "*.behat.yml" },
    url = "https://json.schemastore.org/behat.json" },
  { name = "bozr.suite.json", description = "Bozr test suite file", fileMatch = { ".suite.json", ".xsuite.json" },
    url = "https://json.schemastore.org/bozr.json" },
  { name = "browser.i18n.json", description = "browser.i18n messages.json translation file",
    fileMatch = { "messages.json" }, url = "https://json.schemastore.org/browser.i18n.json" },
  { name = "bucklescript", description = "BuckleScript configuration file", fileMatch = { "bsconfig.json" },
    url = "https://raw.githubusercontent.com/rescript-lang/rescript-compiler/master/docs/docson/build-schema.json" },
  { name = "Bukkit plugin.yml", description = "Schema for Minecraft Bukkit plugin description files",
    fileMatch = { "plugin.yml" }, url = "https://json.schemastore.org/bukkit-plugin.json" },
  ...
  }, url = "https://raw.githubusercontent.com/buildkite/pipeline-schema/master/schema.json" },
  {
    ...
    versions = { ["0.41.2"] = "https://json.schemastore.org/sourcehut-build-0.41.2.json",
      ["0.65.0"] = "https://json.schemastore.org/sourcehut-build-0.65.0.json" }
  },
  { name = "bundleconfig.json", description = "Schema for bundleconfig.json files", fileMatch = { "bundleconfig.json" },
    url = "https://json.schemastore.org/bundleconfig.json" },
  { name = "BungeeCord plugin.yml", description = "Schema for BungeeCord plugin description files",
    fileMatch = { "plugin.yml", "bungee.yml" }, url = "https://json.schemastore.org/bungee-plugin.json" },
  {
    name = "block.json",
  ...
  { name = "CMake Presets", description = "Schema for CMake Presets",
    fileMatch = { "CMakePresets.json", "CMakeUserPresets.json" },
    url = "https://raw.githubusercontent.com/Kitware/CMake/master/Help/manual/presets/schema.json" },
  { name = "Camel YAML DSL", description = "Schema for Camel YAML DSL", fileMatch = { "*.camel.yaml", "*.camelk.yaml" },
  ...
  { name = "Carafe", description = "Schema for Carafe compatible JavaScript Bundles",
    url = "https://carafe.fm/schema/draft-02/bundle.schema.json",
    versions = { ["draft-02"] = "https://carafe.fm/schema/draft-02/bundle.schema.json",
      ["draft-01"] = "https://carafe.fm/schema/draft-01/bundle.schema.json" } },
  { name = "Catalog Info Backstage", description = "Schema for Backstage Catalog Info",
    url = "https://json.schemastore.org/catalog-info.json", fileMatch = { "catalog-info.yaml" } },
  { name = "CityJSON", description = "Schema for the representation of 3D city models",
    url = "https://raw.githubusercontent.com/cityjson/specs/1.0.1/schemas/cityjson.min.schema.json" },
  { name = "Helm Chart.yaml", description = "The Chart.yaml file is required for a chart.", fileMatch = { "Chart.yaml" },
    url = "https://json.schemastore.org/chart.json" },
  { name = "Helm Chart.lock", description = "The Chart.lock file locks dependencies from Chart.yaml",
    fileMatch = { "Chart.lock" }, url = "https://json.schemastore.org/chart-lock.json" },
  { name = "CircleCI config.yml", description = "Schema for CircleCI 2.0 config files",
    fileMatch = { ".circleci/config.yml" }, url = "https://json.schemastore.org/circleciconfig.json" },
  { name = "Code Climate",
    description = "Configuration file as an alternative for configuring your repository in the settings page.",
    fileMatch = { ".codeclimate.yml", ".codeclimate.json" }, url = "https://json.schemastore.org/codeclimate.json" },
  { name = ".cirrus.yml", description = "Cirrus CI configuration files", fileMatch = { ".cirrus.yml" },
    url = "https://json.schemastore.org/cirrus.json" },
  { name = ".clasp.json", description = "Google Apps Script CLI project file", fileMatch = { ".clasp.json" },
    url = "https://json.schemastore.org/clasp.json" },
  { name = "cloudify", description = "Cloudify Blueprint", fileMatch = { "*.cfy.yaml" },
    url = "https://json.schemastore.org/cloudify.json" },
  { name = "codemagic", description = "JSON schema for Codemagic CI/CD file configuration",
    fileMatch = { "codemagic.yaml", "codemagic.yml" }, url = "https://static.codemagic.io/codemagic-schema.json" },
  { name = "JSON schema for Codecov configuration files", description = "Schema for codecov.yml files.",
    fileMatch = { ".codecov.yml", "codecov.yml" }, url = "https://json.schemastore.org/codecov.json" },
  { name = "JSON schema for CodeShip Pro services configuration files",
    description = "Schema for codeship-services.yml files.", fileMatch = { "codeship-services.yml" },
    url = "https://json.schemastore.org/codeship-services.json" },
  { name = "JSON schema for CodeShip Pro steps configuration files", description = "Schema for codeship-steps.yml files.",
    fileMatch = { "codeship-steps.yml" }, url = "https://json.schemastore.org/codeship-steps.json" },
  { name = "VSCode Code Snippets", description = "Schema for code snippet files in visual studio code extensions",
    fileMatch = { "*.code-snippets" },
    url = "https://raw.githubusercontent.com/Yash-Singh1/vscode-snippets-json-schema/main/schema.json" },
  { name = "compilerconfig.json", description = "Schema for compilerconfig.json files",
    fileMatch = { "compilerconfig.json" }, url = "https://json.schemastore.org/compilerconfig.json" },
  { name = "compile_commands.json", description = "LLVM compilation database", fileMatch = { "compile_commands.json" },
    url = "https://json.schemastore.org/compile-commands.json" },
  { name = "commands.json", description = "Config file for Command Task Runner", fileMatch = { "commands.json" },
    url = "https://json.schemastore.org/commands.json" },
  { name = "cosmos.config.json", description = "React Cosmos configuration file", fileMatch = { "cosmos.config.json" },
    url = "https://json.schemastore.org/cosmos-config.json" },
  { name = "Chrome Extension", description = "Google Chrome extension manifest file",
    url = "https://json.schemastore.org/chrome-manifest.json" },
  { name = "chutzpah.json", description = "Chutzpah configuration file", fileMatch = { "chutzpah.json" },
    url = "https://json.schemastore.org/chutzpah.json" },
  { name = "contentmanifest.json", description = "Visual Studio manifest injection file",
    fileMatch = { "contentmanifest.json" }, url = "https://json.schemastore.org/vsix-manifestinjection.json" },
  { name = "cloud-sdk-pipeline-config-schema", description = "SAP Cloud SDK Pipeline configuration",
    fileMatch = { "pipeline_config.yml" }, url = "https://json.schemastore.org/cloud-sdk-pipeline-config-schema.json" },
  ...
  { name = "Citation File Format", description = "A YAML file with citation metadata for software or datasets.",
    fileMatch = { "CITATION.cff" }, url = "https://citation-file-format.github.io/1.2.0/schema.json" },
  { name = "coffeelint.json", description = "CoffeeLint configuration file", fileMatch = { "coffeelint.json" },
    url = "https://json.schemastore.org/coffeelint.json" },
  { name = "composer.json", description = "PHP Composer configuration file", fileMatch = { "composer.json" },
    url = "https://raw.githubusercontent.com/composer/composer/master/res/composer-schema.json" },
  { name = "component.json", description = "Web component file", fileMatch = { "component.json" },
    url = "https://json.schemastore.org/component.json" },
  { name = "config.json", description = "ASP.NET project config file", fileMatch = { "config.json" },
    url = "https://json.schemastore.org/config.json" },
  { name = "contribute.json", description = "A JSON schema for open-source project contribution data by Mozilla",
  ...
  { name = "crowdin.yml",
    ...
    fileMatch = { "**/crowdin.yml" }, url = "https://json.schemastore.org/crowdin.json" },
  { name = "cypress.json", description = "Cypress.io test runner configuration file", fileMatch = { "cypress.json" },
    url = "https://on.cypress.io/cypress.schema.json" },
  { name = ".creatomic", description = "A config for Atomic Design 4 React generator", fileMatch = { ".creatomic" },
  ...
  { name = ".csscomb.json", description = "A JSON schema CSS Comb's configuration file", fileMatch = { ".csscomb.json" },
    url = "https://json.schemastore.org/csscomb.json" },
  { name = ".csslintrc", description = "A JSON schema CSS Lint's configuration file", fileMatch = { ".csslintrc" },
    url = "https://json.schemastore.org/csslintrc.json" },
  { name = "Dart build configuration", description = "Configuration for Dart's build system",
    url = "https://json.schemastore.org/dart-build.json" },
  { name = "Dart test config", description = "Configuration for Dart's test package", fileMatch = { "dart_test.yaml" },
    url = "https://json.schemastore.org/dart-test.json" },
  { name = "datalogic-scan2deploy-android", description = "Datalogic Scan2Deploy Android file",
    fileMatch = { ".dla.json" }, url = "https://json.schemastore.org/datalogic-scan2deploy-android.json" },
  { name = "datalogic-scan2deploy-ce", description = "Datalogic Scan2Deploy CE file", fileMatch = { ".dlc.json" },
    url = "https://json.schemastore.org/datalogic-scan2deploy-ce.json" },
  { name = "debugsettings.json", description = "A JSON schema for the ASP.NET DebugSettings.json files",
    fileMatch = { "debugsettings.json" }, url = "https://json.schemastore.org/debugsettings.json" },
  { name = "dependabot.json", description = "A JSON schema for the Dependabot config.yml files",
    fileMatch = { ".dependabot/config.yml" }, url = "https://json.schemastore.org/dependabot.json" },
  { name = "dependabot-v2.json", description = "A JSON schema for the GitHub Action's dependabot.yml files",
    fileMatch = { ".github/dependabot.yml" }, url = "https://json.schemastore.org/dependabot-2.0.json" },
  { name = "Deployer Recipe", description = "A JSON schema for Deployer yaml recipes",
    fileMatch = { "deploy.yaml", "deploy.yml" },
    url = "https://raw.githubusercontent.com/deployphp/deployer/master/src/schema.json" },
  { name = "detekt.yml", description = "Detekt Configuration File schema", fileMatch = { "detekt.yml", "detekt.yaml" },
    url = "https://json.schemastore.org/detekt.json" },
  { name = "Discord Webhook", description = "Execute Discord Webhook JSON Schema",
    url = "https://raw.githubusercontent.com/AxoCode/json-schema/master/discord/webhook.json" },
  { name = "docfx.json", description = "A JSON schema for DocFx configuration files", fileMatch = { "docfx.json" },
    url = "https://json.schemastore.org/docfx.json" },
  { name = "Dolittle Artifacts", description = "A JSON schema for a Dolittle bounded context's artifacts",
  ...
  { name = "Dolittle Topology", description = "A JSON schema for a Dolittle bounded context's topology",
  ...
  { name = "dotnetcli.host.json", description = "JSON schema for .NET CLI template host files",
    fileMatch = { "dotnetcli.host.json" }, url = "https://json.schemastore.org/dotnetcli.host.json" },
  { name = "drone.json", description = "Drone CI configuration file", fileMatch = { ".drone.yml" },
    url = "https://json.schemastore.org/drone.json" },
  { name = "Drush site aliases", description = "JSON Schema for Drush 9 site aliases file",
    fileMatch = { "sites/*.site.yml" }, url = "https://json.schemastore.org/drush.site.yml.json" },
  { name = "dss-2.0.0.json", description = "Digital Signature Service Core Protocols, Elements, and Bindings Version 2.0",
    url = "https://json.schemastore.org/dss-2.0.0.json" },
  { name = "dvc.yaml", description = "JSON Schema for dvc.yaml file", fileMatch = { "dvc.yaml" },
    url = "https://raw.githubusercontent.com/iterative/dvcyaml-schema/master/schema.json" },
  { name = "Eclipse Che Devfile", description = "JSON schema for Eclipse Che Devfiles",
  ...
  { name = "ecosystem.json", description = "pm2 ecosystem config file",
  ...
  { name = "Esquio", description = "JSON schema for Esquio configuration files",
    url = "https://json.schemastore.org/esquio.json" },
  { name = "epr-manifest.json", description = "Entry Point Regulation manifest file", fileMatch = { "epr-manifest.json" },
    url = "https://json.schemastore.org/epr-manifest.json" },
  { name = "electron-builder configuration file.", description = "JSON schema for electron-build configuration file.",
    fileMatch = { "electron-builder.json" }, url = "https://json.schemastore.org/electron-builder.json" },
  { name = "evcc.yaml", description = "JSON schema for evcc configuration file.", fileMatch = { "evcc*.yaml" },
  ...
  { name = ".eslintrc", description = "JSON schema for ESLint configuration files",
    fileMatch = { ".eslintrc", ".eslintrc.json", ".eslintrc.yml", ".eslintrc.yaml" },
    url = "https://json.schemastore.org/eslintrc.json" },
  { name = "Facets - FSDL - Application", description = "Facets Stack Definition Language for Applications",
    fileMatch = { "**/application/instances/*.json" },
    url = "https://www.facets.cloud/assets/fsdl/application.schema.json" },
  { name = "fabric.mod.json", description = "Metadata file used by the Fabric mod loader",
    fileMatch = { "fabric.mod.json" }, url = "https://json.schemastore.org/fabric.mod.json" },
  { name = "F-Droid Data metadata", description = "Schema for F-Droid Data app metadata files",
    fileMatch = { "metadata/*.yml" }, url = "https://gitlab.com/fdroid/fdroiddata/-/raw/master/schemas/metadata.json" },
  { name = ".ffizer.yaml", description = "JSON schema for ffizer template configuration files",
    fileMatch = { ".ffizer.yaml" }, url = "https://ffizer.github.io/ffizer/ffizer.schema.json" },
  { name = "first-timers-bot", description = "A bot that helps onboarding new open-source contributors.",
    fileMatch = { ".github/first-timers.yml" }, url = "https://json.schemastore.org/first-timers.json" },
  { name = "Foundry VTT - Manifest", description = "JSON schema for Foundry VTT system.json and module.json files.",
    fileMatch = { "system.json", "module.json" },
    url = "https://gitlab.com/-/snippets/2062623/raw/master/foundryvtt_manifest_schema.json" },
  { name = "Foundry VTT - Template", description = "JSON schema for Foundry VTT template.json files.",
    fileMatch = { "template.json" },
    url = "https://gitlab.com/-/snippets/2062623/raw/master/foundryvtt_template_schema.json" },
  { name = "Fossa configuration file", description = "JSON schema for FOSSA CLI's .fossa.yml configuration file",
    fileMatch = { ".fossa.yml" },
    url = "https://raw.githubusercontent.com/fossas/fossa-cli/master/docs/references/files/fossa-yml.v3.schema.json" },
  { name = "func.yaml", description = "JSON schema for Knative Func Plugin func.yaml files", fileMatch = { "func.yaml" },
  ...
  { name = "function.json", description = "JSON schema for Azure Functions function.json files",
    fileMatch = { "function.json" }, url = "https://json.schemastore.org/function.json" },
  {
    ...
    versions = { latest = "https://raw.githubusercontent.com/cloudtoid/gateway-core/master/src/Cloudtoid.GatewayCore/Options/Schema/2021-07.json",
  ...
  { name = "Global Privacy Control",
    ...
    fileMatch = { "**/.well-known/gpc.json" }, url = "https://json.schemastore.org/gpc.json" },
  { name = "geojson.json", description = "GeoJSON format for representing geographic data.",
    url = "https://json.schemastore.org/geojson.json" },
  { name = "GitVersion", description = "The output from the GitVersion tool", fileMatch = { "gitversion.json" },
    url = "https://json.schemastore.org/gitversion.json" },
  { name = "GitHub Action", description = "YAML schema for GitHub Actions", fileMatch = { "action.yml", "action.yaml" },
    url = "https://json.schemastore.org/github-action.json" },
  { name = "GitHub Funding", description = "YAML schema for GitHub Funding",
    fileMatch = { ".github/FUNDING.yml", ".github/funding.yml", ".github/funding.yaml" },
    url = "https://json.schemastore.org/github-funding.json" },
  { name = "GitHub issue forms", description = "YAML schema for GitHub issue forms",
    fileMatch = { ".github/ISSUE_TEMPLATE/**.yml", ".github/ISSUE_TEMPLATE/**.yaml" },
    url = "https://json.schemastore.org/github-issue-forms.json" },
  { name = "GitHub Issue Template configuration", description = "YAML schema for configuring GitHub Issue Templates",
  ...
  { name = "GitHub Workflow", description = "YAML schema for GitHub Workflow",
  ...
  { name = "gitlab-ci", description = "JSON schema for configuring Gitlab CI", fileMatch = { "*.gitlab-ci.yml" },
    url = "https://gitlab.com/gitlab-org/gitlab/-/raw/master/app/assets/javascripts/editor/schema/ci.json" },
  { name = "Gitpod Configuration", description = "JSON schema for configuring Gitpod.io", fileMatch = { ".gitpod.yml" },
    url = "https://gitpod.io/schemas/gitpod-schema.json" },
  { name = "global.json", description = "ASP.NET global configuration file", fileMatch = { "global.json" },
    url = "https://json.schemastore.org/global.json" },
  { name = "golangci-lint Configuration", description = "golangci-lint configuration file",
    fileMatch = { ".golangci.yml", ".golangci.yaml", ".golangci.toml", ".golangci.json" },
    url = "https://json.schemastore.org/golangci-lint.json" },
  { name = "Goreleaser", description = "Goreleaser configuration file",
    fileMatch = { ".goreleaser.yml", ".goreleaser.yaml", "goreleaser.yml", "goreleaser.yaml" },
    url = "https://goreleaser.com/static/schema.json" },
  { name = "Goreleaser Pro", description = "Goreleaser Pro configuration file",
    url = "https://goreleaser.com/static/schema-pro.json" },
  { name = "Grafana 5.x Dashboard", description = "JSON Schema for Grafana 5.x Dashboards",
    url = "https://json.schemastore.org/grafana-dashboard-5.x.json" },
  { name = "GraphQL Mesh", description = "JSON Schema for GraphQL Mesh config file",
    url = "https://unpkg.com/@graphql-mesh/types/config-schema.json", fileMatch = {
      ".meshrc.yml",
      ".meshrc.yaml",
      ".meshrc.json",
      ".meshrc.js",
  ...
  { name = "GraphQL Config", description = "JSON Schema for GraphQL Config config file",
    url = "https://unpkg.com/graphql-config/config-schema.json", fileMatch = {
      "graphql.config.json",
      "graphql.config.js",
      "graphql.config.yaml",
      "graphql.config.yml",
  ...
  { name = "GraphQL Code Generator", description = "JSON Schema for GraphQL Code Generator config file",
    url = "https://www.graphql-code-generator.com/config.schema.json", fileMatch = {
      "codegen.yml",
      "codegen.yaml",
      "codegen.json",
      "codegen.js",
  ...
  { name = "Grunt copy task", description = "Grunt copy task configuration file", fileMatch = { "copy.json" },
    url = "https://json.schemastore.org/grunt-copy-task.json" },
  { name = "Grunt clean task", description = "Grunt clean task configuration file", fileMatch = { "clean.json" },
    url = "https://json.schemastore.org/grunt-clean-task.json" },
  { name = "Grunt cssmin task", description = "Grunt cssmin task configuration file", fileMatch = { "cssmin.json" },
    url = "https://json.schemastore.org/grunt-cssmin-task.json" },
  { name = "Grunt JSHint task", description = "Grunt JSHint task configuration file", fileMatch = { "jshint.json" },
    url = "https://json.schemastore.org/grunt-jshint-task.json" },
  { name = "Grunt Watch task", description = "Grunt Watch task configuration file", fileMatch = { "watch.json" },
    url = "https://json.schemastore.org/grunt-watch-task.json" },
  { name = "Grunt base task", description = "Schema for standard Grunt tasks",
    fileMatch = { "grunt/*.json", "*-tasks.json" }, url = "https://json.schemastore.org/grunt-task.json" },
  { name = "haxelib.json", description = "Haxelib manifest", fileMatch = { "haxelib.json" },
    url = "https://json.schemastore.org/haxelib.json" },
  { name = "Hayson", description = "Project Haystack data",
  ...
  { name = "host.json", description = "JSON schema for Azure Functions host.json files", fileMatch = { "host.json" },
    url = "https://json.schemastore.org/host.json" },
  { name = "host-meta.json", description = "Schema for host-meta JDR files", fileMatch = { "host-meta.json" },
    url = "https://json.schemastore.org/host-meta.json" },
  { name = ".htmlhintrc", description = "HTML Hint configuration file", fileMatch = { ".htmlhintrc" },
    url = "https://json.schemastore.org/htmlhint.json" },
  { name = "Ory Hydra configuration", description = "Schema for Ory Hydra configuration file",
  ...
  { name = "imageoptimizer.json", description = "Schema for imageoptimizer.json files",
    fileMatch = { "imageoptimizer.json" }, url = "https://json.schemastore.org/imageoptimizer.json" },
  { name = ".imgbotconfig", description = "Imgbot Configuration Files", fileMatch = { ".imgbotconfig" },
  ...
  { name = "ioBroker Package manifest", description = "Schema for ioBroker adapters io-package file",
    fileMatch = { "io-package.json" }, url = "https://json.schemastore.org/io-package.json" },
  { name = "Jekyll configuration", description = "Schema for Jekyll _config.yml", fileMatch = { "_config.yml" },
    url = "https://json.schemastore.org/jekyll.json" },
  { name = "Jenkins X Pipelines", description = "Jenkins X Pipeline YAML configuration files",
    fileMatch = { "jenkins-x*.yml" }, url = "https://jenkins-x.io/schemas/jx-schema.json" },
  { name = "Jenkins X Requirements", description = "Jenkins X Requirements YAML configuration file",
    fileMatch = { "jx-requirements.yml" }, url = "https://jenkins-x.io/schemas/jx-requirements.json" },
  { name = "JFrog File Spec", description = "JFrog File Spec schema definition",
  ...
  { name = ".jsbeautifyrc", description = "js-beautify configuration file", fileMatch = { ".jsbeautifyrc" },
  ...
  { name = ".jsbeautifyrc-nested",
    ...
    fileMatch = { ".jsbeautifyrc" }, url = "https://json.schemastore.org/jsbeautifyrc-nested.json" },
  { name = ".jscsrc", description = "JSCS configuration file", fileMatch = { ".jscsrc", "jscsrc.json" },
    url = "https://json.schemastore.org/jscsrc.json" },
  { name = ".jshintrc", description = "JSHint configuration file", fileMatch = { ".jshintrc" },
    url = "https://json.schemastore.org/jshintrc.json" },
  { name = ".jsinspectrc", description = "JSInspect configuration file", fileMatch = { ".jsinspectrc" },
    url = "https://json.schemastore.org/jsinspectrc.json" },
  { name = "JSON-API", description = "JSON API document", fileMatch = { "*.schema.json" },
    url = "https://jsonapi.org/schema" },
  { name = "JSON Document Transform", description = "JSON Document Transform",
  ...
  { name = "*.jsonld", description = "JSON Linked Data files", fileMatch = { "*.jsonld" },
    url = "https://json.schemastore.org/jsonld.json" },
  { name = "JSONPatch", description = "JSONPatch files", fileMatch = { "*.patch" },
    url = "https://json.schemastore.org/json-patch.json" },
  { name = "jsconfig.json", description = "JavaScript project configuration file", fileMatch = { "jsconfig.json" },
  ...
  { name = "Ory Keto configuration", description = "Schema for Ory Keto configuration file",
  ...
  { name = "kustomization.yaml", description = "Kubernetes native configuration management",
    fileMatch = { "kustomization.yaml", "kustomization.yml" }, url = "https://json.schemastore.org/kustomization.json" },
  ...
  { name = "launchsettings.json", description = "A JSON schema for the ASP.NET LaunchSettings.json files",
    fileMatch = { "launchsettings.json" }, url = "https://json.schemastore.org/launchsettings.json" },
  { name = "lerna.json", description = "A JSON schema for lerna.json files", fileMatch = { "lerna.json" },
    url = "https://json.schemastore.org/lerna.json" },
  { name = "lgtm.yml", description = "A JSON schema for lgtm configuration files",
    fileMatch = { "lgtm.yml", ".lgtm.yml" }, url = "https://json.schemastore.org/lgtm.json" },
  { name = "libman.json", description = "JSON schema for client-side library config files", fileMatch = { "libman.json" },
    url = "https://json.schemastore.org/libman.json" },
  { name = "license-report-config.json", description = "JSON schema for license report tool configuration file",
    fileMatch = { "license-report-config.json" }, url = "https://json.schemastore.org/license-report-config.json" },
  { name = "local.settings.json", description = "JSON schema for Azure Functions local.settings.json files",
    fileMatch = { "local.settings.json" }, url = "https://json.schemastore.org/local.settings.json" },
  { name = "localazy.json",
    description = "JSON schema for Localazy CLI configuration file. More info at https://localazy.com/docs/cli",
    fileMatch = { "localazy.json" }, url = "https://raw.githubusercontent.com/localazy/cli-schema/master/localazy.json" },
  { name = "lsdlschema.json", description = "JSON schema for Linguistic Schema Definition Language files",
    fileMatch = { "*.lsdl.yaml", "*.lsdl.json" }, url = "https://json.schemastore.org/lsdlschema.json" },
  ...
  { name = "Microsoft Band Web Tile", description = "Microsoft Band Web Tile manifest file",
    url = "https://json.schemastore.org/band-manifest.json" },
  { name = "mimetypes.json", description = "JSON Schema for mime type collections", fileMatch = { "mimetypes.json" },
  ...
  { name = "Minecraft Data Pack Advancement",
    ...
    fileMatch = { "**/data/*/advancements/*.json" }, url = "https://json.schemastore.org/minecraft-advancement.json" },
  { name = "Minecraft Data Pack Biome",
    description = "Configuration file defining a biome for a data pack for Minecraft.",
    fileMatch = { "**/data/*/worldgen/biome/*.json" }, url = "https://json.schemastore.org/minecraft-biome.json" },
  ...
  { name = "Minecraft Data Pack Dimension Type",
    ...
    fileMatch = { "**/data/*/dimension_type/*.json" }, url = "https://json.schemastore.org/minecraft-dimension-type.json" },
  { name = "Minecraft Data Pack Dimension",
    description = "Configuration file defining a dimension for a data pack for Minecraft.",
    fileMatch = { "**/data/*/dimension/*.json" }, url = "https://json.schemastore.org/minecraft-dimension.json" },
  ...
  { name = ".mocharc", description = "JSON schema for MochaJS configuration files",
    fileMatch = { ".mocharc.json", ".mocharc.jsonc", ".mocharc.yml", ".mocharc.yaml" },
    url = "https://json.schemastore.org/mocharc.json" },
  { name = ".modernizrrc", description = "Webpack modernizr-loader configuration file", fileMatch = { ".modernizrrc" },
    url = "https://json.schemastore.org/modernizrrc.json" },
  { name = "mycode.json", description = "JSON schema for mycode.js files", fileMatch = { "mycode.json" },
    url = "https://json.schemastore.org/mycode.json" },
  { name = "Netlify config schema", description = "This schema describes the YAML config that Netlify uses",
    fileMatch = { "admin/config*.yml" }, url = "https://json.schemastore.org/netlify.json" },
  { name = "Nightwatch.js", description = "nightwatch.js schema", fileMatch = { "nightwatch.json" },
  ...
  { name = "ninjs (News in JSON)",
    ...
    versions = { ["1.3"] = "https://json.schemastore.org/ninjs-1.3.json",
      ["1.2"] = "https://json.schemastore.org/ninjs-1.2.json", ["1.1"] = "https://json.schemastore.org/ninjs-1.1.json",
  ...
  { name = "nlu.json", description = "Schema for NPM-Link-Up", fileMatch = { "nlu.json", ".nlu.json" },
    url = "https://raw.githubusercontent.com/oresoftware/npm-link-up/master/assets/nlu.schema.json" },
  { name = ".nodehawkrc", description = "JSON schema for .nodehawkrc configuration files.",
    url = "https://json.schemastore.org/nodehawkrc.json", fileMatch = { ".nodehawkrc" } },
  { name = "nodemon.json", description = "JSON schema for nodemon.json configuration files.",
    url = "https://json.schemastore.org/nodemon.json", fileMatch = { "nodemon.json" } },
  { name = ".npmpackagejsonlintrc", description = "Configuration file for npm-package-json-lint",
  ...
  { name = "nuclei-template.yaml", description = "JSON schema for Nuclei Template YAML files.",
    url = "https://raw.githubusercontent.com/projectdiscovery/nuclei/master/nuclei-jsonschema.json",
    fileMatch = { "**/nuclei-templates/**/*.yaml" } },
  { name = "nuget-project.json", description = "JSON schema for NuGet project.json files.",
    url = "https://json.schemastore.org/nuget-project.json",
    versions = { ["3.3.0"] = "https://json.schemastore.org/nuget-project-3.3.0.json" } },
  { name = "nswag.json", description = "JSON schema for nswag configuration",
    url = "https://json.schemastore.org/nswag.json", fileMatch = { "nswag.json" } },
  { name = "ntangle", description = "NTangle (https://github.com/Avanade/ntangle) CDC code-generation configuration.",
  ...
  { name = "Ory Oathkeeper configuration", description = "Schema for Ory Oathkeeper configuration file",
  ...
  { name = "ocelot.json", description = "JSON schema for the Ocelot Api Gateway.", fileMatch = { "ocelot.json" },
    url = "https://json.schemastore.org/ocelot.json" },
  { name = "omnisharp.json", description = "Omnisharp Configuration file", fileMatch = { "omnisharp.json" },
    url = "https://json.schemastore.org/omnisharp.json" },
  {
    ...
    versions = { ["3.0"] = "https://raw.githubusercontent.com/OAI/OpenAPI-Specification/main/schemas/v3.0/schema.json",
      ["3.1"] = "https://raw.githubusercontent.com/OAI/OpenAPI-Specification/main/schemas/v3.1/schema.json" }
  },
  { name = "openfin.json", description = "OpenFin application configuration file",
    url = "https://json.schemastore.org/openfin.json" },
  { name = "Outblocks project configuration", description = "JSON schema for Outblocks project configuration files",
  ...
  { name = "Outblocks App configuration", description = "JSON schema for Outblocks App configuration files",
  ...
  { name = "Outblocks database table", description = "JSON schema for Outblocks database table files",
  ...
  { name = "Ory Kratos configuration", description = "Schema for Ory Kratos configuration file",
  ...
  { name = "OSS Review Toolkit repository configuration", description = "Schema for ORT's repository configuration file",
    fileMatch = { "*.ort.yml" },
  ...
  { name = "package.json", description = "NPM configuration file", fileMatch = { "package.json" },
    url = "https://json.schemastore.org/package.json" },
  {
    ...
    versions = { ["8.0.0"] = "https://json.schemastore.org/package.manifest-8.0.0.json",
      ["7.0.0"] = "https://json.schemastore.org/package.manifest-7.0.0.json" }
  },
  { name = "Packer", description = "Packer template JSON configuration", fileMatch = { "packer.json" },
  ...
  { name = "pattern.json", description = "Patternplate pattern manifest file", fileMatch = { "pattern.json" },
    url = "https://json.schemastore.org/pattern.json" },
  { name = ".pmbot.yml", description = "Pmbot configuration file", fileMatch = { ".pmbot.yml" },
    url = "https://raw.githubusercontent.com/pmbot-io/config/master/pmbot.yml.schema.json" },
  { name = "PocketMine plugin.yml", description = "PocketMine plugin manifest file", fileMatch = { "plugin.yml" },
  ...
  { name = "portman.json", description = "JSON schema for Portman's configuration file",
  ...
  { name = "prisma.yml", description = "prisma.yml service definition file", fileMatch = { "prisma.yml" },
  ...
  { name = "project-1.0.0-beta3.json", description = "ASP.NET vNext project configuration file",
    url = "https://json.schemastore.org/project-1.0.0-beta3.json" },
  { name = "project-1.0.0-beta4.json", description = "ASP.NET vNext project configuration file",
    url = "https://json.schemastore.org/project-1.0.0-beta4.json" },
  { name = "project-1.0.0-beta5.json", description = "ASP.NET vNext project configuration file",
    url = "https://json.schemastore.org/project-1.0.0-beta5.json" },
  { name = "project-1.0.0-beta6.json", description = "ASP.NET vNext project configuration file",
    url = "https://json.schemastore.org/project-1.0.0-beta6.json" },
  { name = "project-1.0.0-beta8.json", description = "ASP.NET vNext project configuration file",
    url = "https://json.schemastore.org/project-1.0.0-beta8.json" },
  { name = "project-1.0.0-rc1.json", description = "ASP.NET vNext project configuration file",
    url = "https://json.schemastore.org/project-1.0.0-rc1.json" },
  { name = "project-1.0.0-rc2.json", description = ".NET Core project configuration file",
    url = "https://json.schemastore.org/project-1.0.0-rc2.json" },
  { name = "prometheus.json", description = "Prometheus configuration file",
    fileMatch = { "prometheus.yml", "prometheus.yaml" }, url = "https://json.schemastore.org/prometheus.json" },
  { name = "prometheus.rules.json", description = "Prometheus rules file", fileMatch = { "*.rules" },
  ...
  { name = "proxies.json", description = "JSON schema for Azure Function Proxies proxies.json files",
    fileMatch = { "proxies.json" }, url = "https://json.schemastore.org/proxies.json" },
  { name = "publiccode.yml", description = "JSON schema for publiccode.yml", fileMatch = { "publiccode.yml" },
    url = "https://json.schemastore.org/publiccode.json" },
  { name = "pubspec.yaml", description = "Schema for pubspecs, the format used by Dart's dependency manager",
    fileMatch = { "pubspec.yaml" }, url = "https://json.schemastore.org/pubspec.json" },
  { name = "Pull Request Labeler", description = "A GitHub Action for automatically labelling pull requests",
    fileMatch = { ".github/labeler.yml" }, url = "https://json.schemastore.org/pull-request-labeler.json" },
  { name = ".putout.json", description = "JSON schema for 🐊Putout configuration file", fileMatch = { ".putout.json" },
    url = "https://json.schemastore.org/putout.json" },
  { name = "pyrseas-0.8.json", description = "Pyrseas database schema versioning for Postgres databases, v0.8",
    fileMatch = { "pyrseas-0.8.json" }, url = "https://json.schemastore.org/pyrseas-0.8.json" },
  { name = "Read the Docs", description = "Read the Docs configuration file",
  ...
  }, url = "https://docs.renovatebot.com/renovate-schema.json" },
  {
    ...
    versions = { ["1.0"] = "https://raw.githubusercontent.com/spiral/roadrunner-binary/master/schemas/config/1.0.schema.json",
      ["2.0"] = "https://raw.githubusercontent.com/spiral/roadrunner-binary/master/schemas/config/2.0.schema.json" }
  },
  { name = "Sapphire CLI Config", description = "Scheme for Sapphire CLI Config (@sapphire/cli)",
  ...
  { name = "sarif-1.0.0.json", description = "Static Analysis Results Interchange Format (SARIF) version 1",
    url = "https://json.schemastore.org/sarif-1.0.0.json" },
  { name = "sarif-2.0.0.json", description = "Static Analysis Results Interchange Format (SARIF) version 2",
    url = "https://json.schemastore.org/sarif-2.0.0.json" },
  { name = "sarif-2.1.0-rtm.2", description = "Static Analysis Results Format (SARIF), Version 2.1.0-rtm.2",
  ...
  { name = "sarif-2.1.0-rtm.3", description = "Static Analysis Results Format (SARIF), Version 2.1.0-rtm.3",
  ...
  { name = "sarif-2.1.0-rtm.4", description = "Static Analysis Results Format (SARIF), Version 2.1.0-rtm.4",
  ...
  { name = "sarif-2.1.0-rtm.5", description = "Static Analysis Results Format (SARIF), Version 2.1.0-rtm.5",
  ...
  { name = "sarif-2.1.0", description = "Static Analysis Results Format (SARIF), Version 2.1.0",
  ...
  { name = "Schema Catalog", description = "JSON Schema catalog files compatible with SchemaStore.org",
    url = "https://json.schemastore.org/schema-catalog.json" },
  { name = "schema.org - Action", description = "JSON Schema for Action as defined by schema.org",
    url = "https://json.schemastore.org/schema-org-action.json" },
  { name = "schema.org - ContactPoint", description = "JSON Schema for ContactPoint as defined by schema.org",
    url = "https://json.schemastore.org/schema-org-contact-point.json" },
  { name = "schema.org - Place", description = "JSON Schema for Place as defined by schema.org",
    url = "https://json.schemastore.org/schema-org-place.json" },
  { name = "schema.org - Thing", description = "JSON Schema for Thing as defined by schema.org",
    url = "https://json.schemastore.org/schema-org-thing.json" },
  { name = "Scoop manifest", description = "Scoop bucket app manifest", fileMatch = { "bucket/**.json" },
    url = "https://raw.githubusercontent.com/lukesampson/scoop/master/schema.json" },
  { name = "Semgrep Rule", description = "Semgrep code scanning patterns and rules",
    fileMatch = { ".semgrep/**.yaml", ".semgrep/**.yml", ".semgrep.yaml", ".semgrep.yml" },
    url = "https://json.schemastore.org/semgrep.json" },
  { name = "settings.job", description = "Azure Webjob settings file", fileMatch = { "settings.job" },
    url = "https://json.schemastore.org/settings.job.json" },
  { name = "sfdx-hardis configuration", description = "Configuration file for sfdx-hardis Salesforce DX plugin",
    fileMatch = { ".sfdx-hardis.yml", ".sfdx-hardis.yaml", "**/branches/.sfdx-hardis.*.yml",
  ...
  { name = "size-limit configuration", description = "Configuration file for size-limit",
    fileMatch = { ".size-limit.json" }, url = "https://json.schemastore.org/size-limit.json" },
  { name = "skyuxconfig.json", description = "SKY UX CLI configuration file",
  ...
  { name = "snapcraft", description = "snapcraft project  (https://snapcraft.io)",
  ...
  { name = "Solidarity", description = "CLI config for enforcing environment settings",
    fileMatch = { ".solidarity", ".solidarity.json" }, url = "https://json.schemastore.org/solidaritySchema.json" },
  { name = "Source Maps v3", description = "Source Map files version 3", fileMatch = { "*.map" },
  ...
  { name = "Sponge Mixin configuration", description = "Configuration file for SpongePowered's Mixin library",
    fileMatch = { "*.mixins.json" }, url = "https://json.schemastore.org/sponge-mixins.json" },
  { name = ".sprite files", description = "Schema for image sprite generation files", fileMatch = { "*.sprite" },
    url = "https://json.schemastore.org/sprite.json" },
  { name = "Azure Static Web Apps configuration file", description = "Documentation: https://aka.ms/swa/config-schema",
    fileMatch = { "staticwebapp.config.json" }, url = "https://json.schemastore.org/staticwebapp.config.json" },
  { name = "Azure Static Web Apps CLI configuration file",
    ...
    fileMatch = { "swa-cli.config.json" }, url = "https://json.schemastore.org/swa-cli.config.json" },
  { name = "StackHead CLI config", description = "Configuration file for StackHead CLI. See https://stackhead.io.",
  ...
  { name = "Stale",
    ...
    fileMatch = { ".github/stale.yml" }, url = "https://json.schemastore.org/stale.json" },
  ...
  { name = "StyleCop Analyzers Configuration", description = "Configuration file for StyleCop Analyzers",
  ...
  { name = ".stylelintrc", description = "Configuration file for stylelint",
  ...
  { name = "Swagger API 2.0", description = "Swagger API 2.0 schema", fileMatch = { "swagger.json" },
    url = "https://json.schemastore.org/swagger-2.0.json" },
  { name = "Taurus", description = "Taurus bzt cli framework config",
    fileMatch = { "bzt.yml", "bzt.yaml", "taurus.yml", "taurus.yaml" }, url = "https://json.schemastore.org/taurus.json" },
  { name = "template.json", description = "JSON schema .NET template files",
    fileMatch = { ".template.config/template.json" }, url = "https://json.schemastore.org/template.json" },
  { name = "templatsources.json", description = "SideWaffle template source schema",
    fileMatch = { "templatesources.json" }, url = "https://json.schemastore.org/templatesources.json" },
  {
    name = "theme.json",
    ...
    versions = { v1 = "https://raw.githubusercontent.com/WordPress/gutenberg/b40b61fabf13a6229c616527689d9a7024f81535/schemas/json/theme.json",
      trunk = "https://raw.githubusercontent.com/WordPress/gutenberg/trunk/schemas/json/theme.json" }
  },
  { name = "tmLanguage", description = "Language grammar description files in Textmate and compatible editors",
    fileMatch = { "*.tmLanguage.json" },
    url = "https://raw.githubusercontent.com/Septh/tmlanguage/master/tmLanguage.schema.json" },
  { name = "TestEnvironment.json", description = "Schema for Visual Studio's test environment config",
    fileMatch = { "testEnvironments.json" }, url = "https://json.schemastore.org/testenvironments.json" },
  { name = ".travis.yml", description = "Travis CI configuration file", fileMatch = { ".travis.yml" },
    url = "https://json.schemastore.org/travis.json" },
  { name = "Traefik v2", description = "Traefik v2 YAML configuration file",
    fileMatch = { "traefik.yml", "traefik.yaml" }, url = "https://json.schemastore.org/traefik-v2.json" },
  { name = "Traefik v2 File Provider", description = "Traefik v2 Dynamic Configuration File Provider",
  ...
  { name = "trunk.yaml schema",
    ...
    fileMatch = { "trunk.yaml" }, url = "https://json.schemastore.org/trunk-yaml.json" },
  { name = "tsconfig.json", description = "TypeScript compiler configuration file", fileMatch = { "tsconfig.json" },
    url = "https://json.schemastore.org/tsconfig.json" },
  { name = "tsd.json", description = "JSON schema for DefinitelyTyped description manager (TSD)",
    fileMatch = { "tsd.json" }, url = "https://json.schemastore.org/tsd.json" },
  { name = "tsdrc.json", description = "TypeScript Definition manager (tsd) global settings file",
    fileMatch = { ".tsdrc" }, url = "https://json.schemastore.org/tsdrc.json" },
  { name = "ts-force-config.json", description = "Generated Typescript classes for Salesforce",
    fileMatch = { "ts-force-config.json" }, url = "https://json.schemastore.org/ts-force-config.json" },
  { name = "tslint.json", description = "TypeScript Lint configuration file",
    fileMatch = { "tslint.json", "tslint.yaml", "tslint.yml" }, url = "https://json.schemastore.org/tslint.json" },
  { name = "typewiz.json", description = "Typewiz configuration file", fileMatch = { "typewiz.json" },
    url = "https://json.schemastore.org/typewiz.json" },
  { name = "typings.json", description = "Typings TypeScript definitions manager definition file",
    fileMatch = { "typings.json" }, url = "https://json.schemastore.org/typings.json" },
  { name = "typingsrc.json", description = "Typings TypeScript definitions manager configuration file",
    fileMatch = { ".typingsrc" }, url = "https://json.schemastore.org/typingsrc.json" },
  { name = "up.json", description = "Up configuration file", fileMatch = { "up.json" },
    url = "https://json.schemastore.org/up.json" },
  { name = "UI5 Manifest", description = "UI5 Manifest (manifest.json)",
  ...
  { name = "vega.json", description = "Vega visualization specification file", fileMatch = { "*.vg", "*.vg.json" },
    url = "https://json.schemastore.org/vega.json" },
  { name = "vega-lite.json", description = "Vega-Lite visualization specification file",
    fileMatch = { "*.vl", "*.vl.json" }, url = "https://json.schemastore.org/vega-lite.json" },
  { name = "Vela Pipeline Configuration", description = "Vela Pipeline Configuration File",
    fileMatch = { ".vela.yml", ".vela.yaml" },
    url = "https://github.com/go-vela/types/releases/latest/download/schema.json" },
  { name = "version.json", description = "A project version descriptor file used by Nerdbank.GitVersioning",
  ...
  { name = "vim-addon-info", description = "JSON schema for vim plugin addon-info.json metadata files",
    fileMatch = { "*vim*/addon-info.json" }, url = "https://json.schemastore.org/vim-addon-info.json" },
  { name = "vsls.json", description = "Visual Studio Live Share configuration file", fileMatch = { ".vsls.json" },
    url = "https://json.schemastore.org/vsls.json" },
  { name = "vs-2017.3.host.json", description = "JSON schema for Visual Studio template host file",
    fileMatch = { "vs-2017.3.host.json" }, url = "https://json.schemastore.org/vs-2017.3.host.json" },
  { name = "vs-nesting.json", description = "JSON schema for Visual Studio's file nesting feature",
    fileMatch = { "*.filenesting.json", ".filenesting.json" }, url = "https://json.schemastore.org/vs-nesting.json" },
  { name = ".vsconfig", description = "JSON schema for Visual Studio component configuration files",
    fileMatch = { "*.vsconfig" }, url = "https://json.schemastore.org/vsconfig.json" },
  { name = ".vsext", description = "JSON schema for Visual Studio extension pack manifests", fileMatch = { "*.vsext" },
    url = "https://json.schemastore.org/vsext.json" },
  { name = "VSIX CLI publishing", description = "JSON schema for Visual Studio extension publishing",
    fileMatch = { "vs-publish.json" }, url = "https://json.schemastore.org/vsix-publish.json" },
  { name = "vss-extension.json", description = "JSON Schema for Azure DevOps Extensions",
    fileMatch = { "vss-extension.json" }, url = "https://json.schemastore.org/vss-extension.json" },
  { name = "<div>RIOTS' studio configuration", description = "JSON schema for the <div>RIOTS' studio configuration",
    fileMatch = { "studio.config.json" }, url = "https://webcomponents.dev/assets2/schemas/studio.config.json" },
  { name = "WebExtensions", description = "JSON schema for WebExtension manifest files", fileMatch = { "manifest.json" },
    url = "https://json.schemastore.org/webextension.json" },
  { name = "Web App Manifest", description = "Web Application manifest file",
    fileMatch = { "manifest.json", "*.webmanifest" }, url = "https://json.schemastore.org/web-manifest-combined.json" },
  { name = "webjobs-list.json", description = "Azure Webjob list file", fileMatch = { "webjobs-list.json" },
    url = "https://json.schemastore.org/webjobs-list.json" },
  { name = "webjobpublishsettings.json", description = "Azure Webjobs publish settings file",
    fileMatch = { "webjobpublishsettings.json" }, url = "https://json.schemastore.org/webjob-publish-settings.json" },
  { name = "Web types", description = "JSON standard for web component libraries metadata",
    fileMatch = { "web-types.json", "*.web-types.json" }, url = "https://json.schemastore.org/web-types.json" },
  { name = "JSON-stat 2.0", description = "JSON-stat 2.0 Schema", url = "https://json-stat.org/format/schema/2.0/" },
  { name = "KSP-AVC", description = "The .version file format for KSP-AVC", fileMatch = { "*.version" },
    url = "https://raw.githubusercontent.com/linuxgurugamer/KSPAddonVersionChecker/1.4.1.5/KSP-AVC.schema.json" },
  { name = "KSP-CKAN", description = "Metadata spec for KSP-CKAN", fileMatch = { "*.ckan" },
    url = "https://raw.githubusercontent.com/KSP-CKAN/CKAN/v1.28.0/CKAN.schema" },
  { name = "JSON Schema Draft 4", description = "Meta-validation schema for JSON Schema Draft 4",
    url = "https://json-schema.org/draft-04/schema" },
  { name = "JSON Schema Draft 7", description = "Meta-validation schema for JSON Schema Draft 7",
    url = "https://json-schema.org/draft-07/schema" },
  { name = "JSON Schema Draft 8", description = "Meta-validation schema for JSON Schema Draft 8",
    url = "https://json-schema.org/draft/2019-09/schema" },
  { name = "JSON Schema Draft 2020-12", description = "Meta-validation schema for JSON Schema Draft 2020-12",
    url = "https://json-schema.org/draft/2020-12/schema" },
  { name = "xunit.runner.json", description = "xUnit.net runner configuration file", fileMatch = { "xunit.runner.json" },
    url = "https://json.schemastore.org/xunit.runner.schema.json" },
  { name = "servicehub.service.json", description = "Microsoft ServiceHub Service",
    fileMatch = { "*.servicehub.service.json" }, url = "https://json.schemastore.org/servicehub.service.schema.json" },
  { name = "servicehub.config.json", description = "Microsoft ServiceHub Configuration",
    fileMatch = { "servicehub.config.json" }, url = "https://json.schemastore.org/servicehub.config.schema.json" },
  { name = ".cryproj engine-5.2", description = "A JSON schema for CRYENGINE projects (.cryproj files)",
    fileMatch = { "*.cryproj" }, url = "https://json.schemastore.org/cryproj.52.schema.json" },
  { name = ".cryproj engine-5.3", description = "A JSON schema for CRYENGINE projects (.cryproj files)",
    fileMatch = { "*.cryproj" }, url = "https://json.schemastore.org/cryproj.53.schema.json" },
  { name = ".cryproj engine-5.4", description = "A JSON schema for CRYENGINE projects (.cryproj files)",
    fileMatch = { "*.cryproj" }, url = "https://json.schemastore.org/cryproj.54.schema.json" },
  { name = ".cryproj engine-5.5", description = "A JSON schema for CRYENGINE projects (.cryproj files)",
    fileMatch = { "*.cryproj" }, url = "https://json.schemastore.org/cryproj.55.schema.json" },
  { name = ".cryproj engine-dev", description = "A JSON schema for CRYENGINE projects (.cryproj files)",
    fileMatch = { "*.cryproj" }, url = "https://json.schemastore.org/cryproj.dev.schema.json" },
  { name = ".cryproj (generic)", description = "A JSON schema for CRYENGINE projects (.cryproj files)",
    fileMatch = { "*.cryproj" }, url = "https://json.schemastore.org/cryproj.json" },
  { name = "typedoc.json", description = "A JSON schema for the Typedoc configuration file",
    fileMatch = { "typedoc.json" }, url = "https://typedoc.org/schema.json" },
  { name = "huskyrc", description = "Husky can prevent bad `git commit`, `git push` and more 🐶 woof!",
    fileMatch = { ".huskyrc", ".huskyrc.json" }, url = "https://json.schemastore.org/huskyrc.json" },
  { name = ".lintstagedrc", description = "JSON schema for lint-staged config",
    fileMatch = { ".lintstagedrc", ".lintstagedrc.json" }, url = "https://json.schemastore.org/lintstagedrc.schema.json" },
  { name = "mta.yaml", description = "A JSON schema for MTA projects v3.3", fileMatch = { "mta.yaml", "mta.yml" },
    url = "https://json.schemastore.org/mta.json" },
  { name = "mtad.yaml", description = "A JSON schema for MTA deployment descriptors v3.3",
    fileMatch = { "mtad.yaml", "mtad.yml" }, url = "https://json.schemastore.org/mtad.json" },
  { name = ".mtaext", description = "A JSON schema for MTA extension descriptors v3.3", fileMatch = { "*.mtaext" },
    url = "https://json.schemastore.org/mtaext.json" },
  { name = "xs-app.json", description = "JSON schema for the SAP Application Router v8.2.2",
    fileMatch = { "xs-app.json" }, url = "https://json.schemastore.org/xs-app.json" },
  { name = "Opctl", description = "Opctl schema for describing an op",
    url = "https://json.schemastore.org/opspec-io-0.1.7.json", fileMatch = { ".opspec/*/*.yml", ".opspec/*/*.yaml" } },
  {
    name = "HEMTT",
  ...
  { name = "now", description = "ZEIT Now project configuration file", fileMatch = { "now.json" },
    url = "https://json.schemastore.org/now.json" },
  { name = "taskcat", description = "taskcat", fileMatch = { ".taskcat.yml" },
    url = "https://raw.githubusercontent.com/aws-quickstart/taskcat/0.9.20/taskcat/cfg/config_schema.json" },
  { name = "BizTalkServerApplicationSchema", description = "BizTalk server application inventory json file.",
    fileMatch = { "BizTalkServerInventory.json" },
    url = "https://json.schemastore.org/BizTalkServerApplicationSchema.json" },
  { name = "httpmockrc", description = "Http-mocker is a tool for mock local requests or proxy remote requests.",
    fileMatch = { ".httpmockrc", ".httpmock.json" }, url = "https://json.schemastore.org/httpmockrc.json" },
  { name = "neoload",
  ...
  { name = "release drafter", description = "Release Drafter configuration file",
  ...
  { name = "zuul", description = "Zuul CI configuration file", fileMatch = { "*zuul.d/*.yaml", "*/.zuul.yaml" },
    url = "https://raw.githubusercontent.com/pycontribs/zuul-lint/0.1.1/zuul_lint/zuul-schema.json" },
  { name = "Briefcase", description = "Microsoft Briefcase configuration file", fileMatch = { "briefcase.yaml" },
    url = "https://raw.githubusercontent.com/microsoft/Briefcase/master/mlbriefcase/briefcase-schema.json" },
  { name = "httparchive", description = "HTTP Archive", fileMatch = { "*.har" },
    url = "https://raw.githubusercontent.com/ahmadnassri/har-schema/v2.0.0/lib/har.json" },
  { name = "jsdoc", description = "JSDoc configuration file", fileMatch = { "conf.js*", "jsdoc.js*" },
    url = "https://json.schemastore.org/jsdoc-1.0.0.json" },
  { name = "Ray", description = "Ray autocluster configuration file", fileMatch = { "ray-*-cluster.yaml" },
    url = "https://raw.githubusercontent.com/ray-project/ray/ray-1.0.0/python/ray/autoscaler/ray-schema.json" },
  { name = "Hadolint", description = "A smarter Dockerfile linter that helps you build best practice Docker images.",
  ...
  { name = "helmfile", description = "Helmfile is a declarative spec for deploying helm charts",
    fileMatch = { "helmfile.yaml", "helmfile.d/**/*.yaml" }, url = "https://json.schemastore.org/helmfile.json" },
  ...
  { name = "Žinoma", description = "Žinoma incremental build configuration", fileMatch = { "zinoma.yml" },
    url = "https://github.com/fbecart/zinoma/releases/latest/download/zinoma-schema.json" },
  {
    ...
    versions = { ["0.1"] = "https://json.schemastore.org/winget-pkgs-singleton-0.1.json",
  ...
  { name = ".commitlintrc", description = "JSON schema for commitlint configuration files",
    fileMatch = { ".commitlintrc", ".commitlintrc.json" }, url = "https://json.schemastore.org/commitlintrc.json" },
  { name = "Uniswap Token List", description = "A list of tokens compatible with the Uniswap Interface",
    fileMatch = { "*.tokenlist.json" }, url = "https://uniswap.org/tokenlist.schema.json" },
  { name = "yamllint", description = "yamllint uses a set of rules to check source files for problems",
    ...
    url = "https://json.schemastore.org/yamllint.json" },
  {
    ...
    versions = { ["1.1.2"] = "https://raw.githubusercontent.com/nagyesta/yippee-ki-json/v1.1.2/schema/yippee-ki-json_config_schema.json",
  ...
  { name = "tsoa", description = "JSON Schema for the tsoa configuration file",
    url = "https://json.schemastore.org/tsoa.json", fileMatch = { "**/tsoa.json" } },
  { name = "API Builder", description = "apibuilder.io schema", fileMatch = { "**/api.json" },
    url = "https://json.schemastore.org/apibuilder.json" },
  {
    ...
    versions = { ["1.0"] = "https://docs.gradle.com/enterprise/admin/schema/gradle-enterprise-config-schema-1.json",
  ...
  },
  {
    ...
    versions = { ["1.0"] = "https://docs.gradle.com/build-cache-node/schema/build-cache-node-config-schema-1.json",
  ...
  { name = ".yarnrc.yml", description = "JSON Schema for Yarnrc files", fileMatch = { ".yarnrc.yml" },
    url = "https://yarnpkg.com/configuration/yarnrc.json" },
  { name = "beau.yml", description = "JSON Schema for a Beaujs Requests file.", fileMatch = { "beau.yml" },
  ...
  { name = "Better Code Hub",
    ...
    fileMatch = { ".bettercodehub.yml" }, url = "https://json.schemastore.org/bettercodehub.json" },
  { name = "comet", description = "JSON Schema for a Comet Data Pipeline.", fileMatch = { "*.comet.yaml", "*.comet.yml" },
    url = "https://json.schemastore.org/comet.json" },
  { name = "swcrc", description = "JSON Schema for swc configuration files.", fileMatch = { ".swcrc" },
    url = "https://json.schemastore.org/swcrc.json" },
  { name = "OpenWeather Road Risk API", description = "JSON Schema for OpenWeather Road Risk API responses.",
    fileMatch = {}, url = "https://json.schemastore.org/openweather.roadrisk.json" },
  { name = "OpenWeather Current Weather API", description = "JSON Schema for OpenWeather Current Weather API responses.",
    fileMatch = {}, url = "https://json.schemastore.org/openweather.current.json" },
  { name = "JSON-e templates", description = "JSON Schema for JSON-e templates.", fileMatch = {},
    url = "https://json.schemastore.org/jsone.json" },
  { name = "Taskfile YAML Schema", description = "JSON Schema for Taskfile files.",
    fileMatch = { "Taskfile.yaml", "Taskfile.yml" }, url = "https://json.schemastore.org/taskfile.json" },
  { name = "Hammerkit YAML Schema", description = "JSON Schema for hammerkit files.",
    fileMatch = { "build.yaml", "build.yml" }, url = "https://json.schemastore.org/hammerkit.json" },
  { name = "Containerlab", description = "JSON Schema for Containerlab topology definition files.",
  ...
  { name = "User Journey Map YAML Schema", description = "JSON Schema for user journey map definition files.",
  ...
  { name = "RKE Cluster Configuration JSON Schema",
    description = "JSON Schema for the cluster.json configuration file for RKE", fileMatch = { "cluster.json" },
    url = "https://raw.githubusercontent.com/dcermak/vscode-rke-cluster-config/main/schemas/cluster.json" },
  {
    ...
    versions = { ["1.0"] = "https://json.schemastore.org/liquibase.json",
  ...
  { name = "SauceCTL Configuration", description = "JSON Schema for SauceCTL configuration files.",
    fileMatch = { "**/.sauce/*.yml" },
    url = "https://raw.githubusercontent.com/saucelabs/saucectl/main/api/v1alpha/generated/saucectl.schema.json" },
  { name = "fulibWorkflows", description = "JSON Schema for fulibWorkflows", fileMatch = { "*.es.yaml", "*.es.yml" },
    url = "https://raw.githubusercontent.com/fujaba/fulibWorkflows/main/schemas/fulibWorkflows.schema.json" },
  { name = "Woodpecker pipeline config", description = "YAML schema for configuring Woodpecker CI",
  ...
  { name = "Netin Diagnostic System Template", description = "Device template schema",
  ...
  { description = "YAML Schema for NOODL applications", fileMatch = { "*.noodl.yml" }, name = "noodl.schema.json",
    url = "https://noodl.s3.us-west-1.amazonaws.com/noodl.schema.json" },
  {
    ...
    versions = { ["0.1"] = "https://json.schemastore.org/mboats-config-0.1.json",
      ["0.2"] = "https://json.schemastore.org/mboats-config-0.1.json" }
  },
  { name = "StackHawk Scanner Configuration", description = "Schema for StackHawk Scanner configuration files",
